...
TOGETHER_API_KEY = os.getenv("TOGETHER_API_KEY", "")  # NOTE: a real key was hardcoded here previously — rotate it on together.ai if this repo was ever pushed publicly
